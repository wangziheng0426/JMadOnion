...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.exportBip_checkBox = QtGui.QCheckBox(self.centralwidget)
        self.exportBip_checkBox.setObjectName(_fromUtf8("exportBip_checkBox"))
        self.horizontalLayout.addWidget(self.exportBip_checkBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exportBip_checkBox.setText(_translate("MainWindow", "ExportBip", None))
        ...
        self.pushButton_MaxToFbx.setText(_translate("MainWindow", "导出max文件", None))

...
class Ui_settingDialog(object):
    def setupUi(self, settingDialog):
        ...
        self.lineEdit_source.setGeometry(QtCore.QRect(20, 90, 331, 31))
        self.lineEdit_source.setObjectName(_fromUtf8("lineEdit_source"))
        self.pushButton_source = QtGui.QPushButton(settingDialog)
        self.pushButton_source.setGeometry(QtCore.QRect(380, 90, 81, 31))
        ...
        self.pushButton_destination.setGeometry(QtCore.QRect(380, 140, 81, 31))
        ...
        self.lineEdit_destination.setGeometry(QtCore.QRect(20, 140, 331, 31))
        ...
        self.apply_pushButton.setGeometry(QtCore.QRect(270, 260, 81, 31))
        ...
        self.pushButton_unityAssetPath = QtGui.QPushButton(settingDialog)
        self.pushButton_unityAssetPath.setGeometry(QtCore.QRect(380, 190, 81, 31))
        self.pushButton_unityAssetPath.setObjectName(_fromUtf8("pushButton_unityAssetPath"))
        self.lineEdit_unityPath = QtGui.QLineEdit(settingDialog)
        self.lineEdit_unityPath.setGeometry(QtCore.QRect(20, 190, 331, 31))
        self.lineEdit_unityPath.setObjectName(_fromUtf8("lineEdit_unityPath"))
    ...
    def retranslateUi(self, settingDialog):
        ...
        self.pushButton_unityAssetPath.setText(_translate("settingDialog", "AssetPath", None))

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(651, 637)
        self.cw = QtGui.QWidget(MainWindow)
        self.cw.setObjectName(_fromUtf8("cw"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.cw)
        ...
        self.verticalLayout_2.addWidget(self.tableView_fileList)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_rename.setText(_translate("MainWindow", "改！", None))

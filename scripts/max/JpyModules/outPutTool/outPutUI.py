...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeWidget_Out.headerItem().setText(0, _fromUtf8("1"))
        self.pushButton_MaxToFbx = QtGui.QPushButton(self.centralwidget)
        self.pushButton_MaxToFbx.setGeometry(QtCore.QRect(10, 590, 101, 41))
        self.pushButton_MaxToFbx.setObjectName(_fromUtf8("pushButton_MaxToFbx"))
        self.pushButton_4 = QtGui.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(150, 590, 101, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_MaxToFbx.setText(_translate("MainWindow", "导出max到fbx", None))

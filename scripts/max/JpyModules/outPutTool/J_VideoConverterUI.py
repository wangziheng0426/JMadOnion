...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeView_list = QtGui.QTreeView(self.centralwidget)
        self.treeView_list.setGeometry(QtCore.QRect(10, 10, 431, 531))
        self.treeView_list.setEditTriggers(QtGui.QAbstractItemView.DoubleClicked|QtGui.QAbstractItemView.EditKeyPressed|QtGui.QAbstractItemView.SelectedClicked)
        self.treeView_list.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        self.treeView_list.setObjectName(_fromUtf8("treeView_list"))

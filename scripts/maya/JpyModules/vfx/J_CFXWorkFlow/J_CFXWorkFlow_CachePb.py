...
def J_CFXWorkFlow_CachePb(frameRate=1):
    ...
    cmds.playblast(format="qt",quality=100,viewer=True,offScreen=True,forceOverwrite=True,filename=j_PbPath,widthHeight=(1920,1080),

...
import os,shutil
def J_renderPreview(resolution=None,camera='',animationRange=None,renderer="arnold",skipFrame=0,renderMode=1,waterMark="",audio=''):
    ...
    renderFileName=Jpy.public.J_getMayaFileNameWithOutExtension()
    ...
    Jpy.public.J_ffmpeg.createAssFile(renderPath+renderFileName+'.ass',frameRate,[int(animationRange[0]+skipFrame),int(animationRange[1])]
    ...
    finalFile=Jpy.public.J_ffmpeg.p2v(compressPath=renderPath,frameRate=frameRate,

...
class Ui_J_managerWin(object):
    def setupUi(self, J_managerWin):
        ...
        self.pushButton_pro = QtGui.QPushButton(self.centralwidget)
        self.pushButton_pro.setObjectName(_fromUtf8("pushButton_pro"))
        self.gridLayout_2.addWidget(self.pushButton_pro, 3, 1, 1, 1)
        ...
        self.lineEdit_pluginPath = QtGui.QLineEdit(self.centralwidget)
        self.lineEdit_pluginPath.setObjectName(_fromUtf8("lineEdit_pluginPath"))
        self.gridLayout_2.addWidget(self.lineEdit_pluginPath, 3, 0, 1, 1)
    ...
    def retranslateUi(self, J_managerWin):
        ...
        self.pushButton_pro.setText(_translate("J_managerWin", "工程目录", None))
